...
<body ng-app="myApp">
   ...
   <!--회원 가입 폼-->
   <div class="container boarder-box">
      <form ng-submit="onSubmit($event)" ng-controller="formCtrl" action="signup.do" method="post" id="signupForm"
       name="signupForm" enctype="multipart/form-data" novalidate>
         <div style="text-align: center;">
            <h2>도그 워커 회원가입 페이지</h2>
            <p>회원가입을 하시면 도그 워커가 될 수 있습니다.</p>
         </div><br /><br />
         <!-- 아이디  -->
         <div class="col-xl-12 form-group has-feedback" ng-class="{'has-success':signupForm.id.$valid && canUseId,
          'has-error': (signupForm.id.$invalid || !canUseId)&& signupForm.id.$dirty }">
            <p><label class="control-label">아이디</label></p>
            <input type="text" id="id" class=" form-control" name="id" placeholder="아이디를 입력해주세요" ng-model="id"
             ng-required="true" ng-change="onIdInput()" ng-pattern="/^[a-zA-Z0-9]{2,8}$/" />
            <p class="help-block" ng-show="signupForm.id.$error.required && signupForm.id.$dirty">
               반드시 입력하세요.</p>
            <p class="help-block" ng-show="!canUseId && signupForm.id.$dirty">
               사용할 수 없는 아이디입니다.</p>
            <p class="help-block" ng-show="signupForm.id.$error.pattern && signupForm.id.$dirty">
               2~8글자 영문, 숫자만 사용할 수 있습니다.</p>
         </div>
         <!-- 닉네임  -->
         <div class="col-xl-12 form-group has-feedback" ng-class="{'has-success':signupForm.nickname.$valid && canUseNickname,
                  'has-error': (signupForm.nickname.$invalid || !canUseNickname) && signupForm.nickname.$dirty }">
            <p><label class="control-label">닉네임</label></p>
            <input type="text" id="nickname" class=" form-control" name="nickname" placeholder="닉네임을 입력해주세요"
               ng-change="onNicknameInput()" ng-model="nickname" ng-pattern="/^[\w가-힣]{2,8}$/" />
            <p class="help-block"
         ...
         <div class="col-xl-12 form-group has-feedback"
            ...
            <label class="control-label">비밀번호</label> <input type="password"
               class=" form-control" name="pwd" ng-model="pwd"
         ...
         <div class="col-xl-12 form-group has-feedback"
            ng-class="{'has-success':signupForm.pwd2.$valid,'has-error': (signupForm.pwd2.$invalid || !isPwdEqual) && signupForm.pwd2.$dirty }">
            <label class="control-label">비밀번호 확인</label> <input type="password"
               class=" form-control" name="pwd2" ng-model="pwd2"
               ng-change="onPwdInput()" ng-required="true"
         ...
         <div class="col-xl-12 form-group has-feedback"
            ...
            <label class="control-label">카카오 아이디</label> <input type="text"
               id="kakao" class="  form-control" name="kakao"
         ...
         <div class="col-xl-12 form-group has-feedback"
            ng-class="{'has-success':signupForm.addr.$valid,'has-error': signupForm.addr.$invalid && signupForm.addr.$dirty }">
            <label class="control-label">주소</label> <input class="form-control"
               type="text" name="addr" id="input_address" placeholder="주소를 입력해주세요"
               ng-model="addr" ng-required="true"><br />
            <p class="help-block"
         ...
         <div class="row" style="margin-left: 6px;">
            ...
            <div class="col-xl-2">
               ...
               <label class="radio-label"> <input type="radio" name="sex"
                  value="woman" checked="checked" />여자
               </label> &nbsp <label class="radio-label"> <input type="radio"
                  name="sex" value="man" checked="checked" />남자
               </label>
            </div>
            <br /> <br />
            <div class="col-xl-2">
               ...
               <label class="radio-label"> <input type="radio"
                  name="hasPet" value="yes" checked="checked" />예
               </label> &nbsp <label class="radio-label"> <input type="radio"
                  name="hasPet" value="no" checked="checked" />아니요 <br /></label>
            </div>
            <br /> <br />
            <div class="col-xl-2">
               <label class="radio-label" for="myFile"><p
                     class="control-label">
                     <b>이미지</b>
                  </p> </label> <input type="file" name="file" id="file" />
            </div>
   ...
   <footer class="text-center">
      <div class="container">
         Copyright &copy; Your Website 2018 <a href="Service/serviceinfo.do">고객센터</a>
      </div>
   </footer>
   <script
