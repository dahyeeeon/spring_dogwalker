...
public class ManageDto {
   ...
   public ManageDto() {}
public ManageDto(int num, String writer, String title, String content, int stars, String nickname, String regdate,
		String imagePath, String orgImageName, String saveImageName, long imageSize, int startRowNum, int endRowNum,
		int prevNum, int nextNum, MultipartFile file, String id, String kakao, String dogSize, String selectDate,
