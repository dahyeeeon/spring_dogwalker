...
<div class="container">
                  ...
                  <tr>
                     ...
                     <c:choose>
						...
						<c:when test="${tmp.isReserved == 0 }">
							...
							<button class="small-btn btn-default" type="button" onclick="javascript:rsvConfirm(${tmp.num })">수락</button>
							<button class="small-btn btn-default" type="button" onclick="javascript:rsvConfirm2(${tmp.num })">거절</button>
						</c:when>
  ...
  <script>
	...
	function rsvConfirm(num){
		var isReserved = confirm("예약을 수락 하시겠습니까?");
