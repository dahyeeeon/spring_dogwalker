		...
		<div class="row">
			<fieldset>
				...
				<input type="text" name="id" id="id"
					value="${dto.id } "disabled /><br> <label for="kakao"></label> <input
					type="text" name="kakao" id="kakao" value="${dto.kakao }" disabled /><br>
				<label for="nickname"></label> <input type="text" name="nickname"
					id="nickname" value="${dto.nickname }" disabled/><br />
