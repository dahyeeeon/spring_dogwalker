...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
   <div class="container">
     <a class="navbar-brand js-scroll-trigger" href="#">   <img class="img-fluid" src="${pageContext.request.contextPath }/resources/img/logo (2).png" style="width:100px; height:100px"></a>
